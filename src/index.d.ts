declare module "recombee-api-client" {
  ...
  export class ApiClient {
    ...
    send<TRequest extends Request>(
      request: TRequest,
      callback?: (error: ResponseError | null, response?: Request["__response_type"]) => void
    ): Promise<Request["__response_type"]>;
  ...
  type AllResponses = RecommendationResponse | SearchResponse;

declare module 'recombee-js-api-client' {
  ...
  export class Batch extends Request {
    ...
    _request_to_batch_object(req: Request): BatchedRequest;
  }
   ...
   */
  export class RecommendItemsToItemSegment extends Request {
    /**
   ...
   */
  export class RecommendNextItemSegments extends Request {
    /**
     * @param recommId - ID of the base recommendation request for which next recommendations should be returned

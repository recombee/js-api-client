...
var CompositeRecommendation = /*#__PURE__*/function (_rqs$Request) {
  ...
  function CompositeRecommendation(scenario, count, optional) {
    ...
    _this.searchQuery = optional.searchQuery;
    _this.cascadeCreate = optional.cascadeCreate;
...
/***/ "./src/requests/recommend-next-item-segments.js":
/*!******************************************************!*\
  !*** ./src/requests/recommend-next-item-segments.js ***!
  \******************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
var RecommendNextItemSegments = /*#__PURE__*/function (_rqs$Request) {
   ...
   */
  function RecommendNextItemSegments(recommId, count) {
    var _this;
    _classCallCheck(this, RecommendNextItemSegments);
    _this = _callSuper(this, RecommendNextItemSegments, ['POST', "/recomms/next/item-segments/".concat(encodeURIComponent(recommId)), 9000, false]);
   ...
   * @return {Object} The values of body parameters (name of parameter: value of the parameter)
   */
  _inherits(RecommendNextItemSegments, _rqs$Request);
  return _createClass(RecommendNextItemSegments, [{
    key: "bodyParameters",
    value: function bodyParameters() {
      var params = {};
      params.count = this.count;
